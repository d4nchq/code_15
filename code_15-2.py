...
df.drop(['Time'], axis=1).plot(figsize=(15, 10), title="Використання велодоріжок у 2010 році")
plt.xlabel("Дата")
plt.ylabel("Кількість відвідувань")
plt.show()

#аналіз даних для визначення найпопулярнішого місяця.
#додаємо новий стовпець з номером місяця.
